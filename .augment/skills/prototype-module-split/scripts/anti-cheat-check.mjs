 ...
 *   3. Audit-manifest: claimed symbols exist in source code
 *   4. Boundary-map: function assignments reference real symbols
 *   5. Boundary-map: load order references match declared targetFiles
 *   6. Split-manifest: declared script/data exports exist in file contents
 *
 * Usage:
