...
void test("shouldUseTemplateByRollout supports all/percentage", () => {
  ...
  const r = { type: "percentage", percentage: 50, salt: "salt" };
...
// ---------------------------------------------------------------------------
function buildVersionClient(createdAt) {
  const client = {
    query: (sql) => {
...
function buildReleaseClient(updatedAt) {
  const client = {
    query: (sql) => {
...
//# sourceMappingURL=templates.service.test.js.map
