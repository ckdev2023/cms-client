...
function makeValidationRunRow(overrides = {}) {
  return {
...
function svc(pool, timeline = makeTimeline()) {
  ...
  return {
    service: new ValidationRunsService(pool, cases.service, timeline.service),
    timeline,
  };
}
...
//# sourceMappingURL=validationRuns.service.test.js.map
