...
import { mapReminderRow } from "../../reminders/reminders.service";
/**
 ...
 */
function buildNotificationJob(reminder) {
  return {
 ...
 * @param row 数据库行
 */
async function processOneReminder(tenantDb, queue, row) {
 ...
 * @param job 队列任务
 */
export async function handleReminderJob(pool, queue, job) {
...
//# sourceMappingURL=reminderJobHandler.js.map
