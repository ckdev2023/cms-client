...
async function translateAndPersist(
  ...
  for (const lang of langs) {
    try {
      ...
      const column = LANG_COLUMN_MAP[lang];
 ...
 * @returns 翻译状态
 */
function resolveStatus(successCount, failCount) {
 ...
 * @param job 队列任务
 */
export async function handleTranslationJob(pool, translationAdapter, job) {
...
//# sourceMappingURL=translationJobHandler.js.map
