...
import { buildUpsertAssetSql } from "../document-assets/documentAssets.shared";
 ...
 * @returns 存储键
 */
export function buildStorageKey(requirementId, fileName) {
 ...
 */
export function mapDocumentFileRow(row) {
  return {
    id: row.id,
    orgId: row.org_id,
 ...
 */
export async function getCaseCustomerId(tx, caseId) {
 ...
 * @returns asset id
 */
export async function upsertAssetInTx(tx, input) {
 ...
 * @returns asset id
 */
export async function resolveAssetId(tx, ctx, input, requirement) {
...
//# sourceMappingURL=documentFiles.shared.js.map
