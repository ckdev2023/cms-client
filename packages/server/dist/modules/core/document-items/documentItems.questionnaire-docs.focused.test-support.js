 ...
 */
export function makeItemRow(overrides = {}) {
  return {
    id: ITEM_ID,
    org_id: ORG_ID,
    case_id: CASE_ID,
 ...
 */
export function createService(pool, timeline) {
  return new DocumentItemsService(pool, timeline.service);
}
//# sourceMappingURL=documentItems.questionnaire-docs.focused.test-support.js.map
