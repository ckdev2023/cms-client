...
function makePaymentRecordListRow(overrides = {}) {
  return {
    ...makePaymentRecordRow(overrides),
    milestone_name: overrides.milestone_name ?? null,
    case_name: overrides.case_name ?? null,
    case_no: overrides.case_no ?? null,
    recorded_by_display_name: overrides.recorded_by_display_name ?? null,
    voided_by_display_name: overrides.voided_by_display_name ?? null,
  };
}
...
//# sourceMappingURL=paymentRecords.service.list.test.js.map
