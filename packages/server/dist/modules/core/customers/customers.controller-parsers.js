 ...
 */
export function parseOptionalTrimmedString(value, field) {
  if (value === undefined) return undefined;
 ...
 * @returns 裁剪后的非空字符串。
 */
export function parseRequiredTrimmedString(value, field) {
 ...
 */
export function parseActiveCases(value) {
  if (value === undefined) return undefined;
 ...
 * @returns 解析后的非空对象。
 */
export function parseRequiredObject(value, field) {
  if (value && typeof value === "object" && !Array.isArray(value)) return value;
 ...
 */
export function parseOptionalNumber(value, field) {
...
const VALID_LOCALES = ["zh", "ja", "en"];
function parseLocaleField(raw, locale) {
  const v = raw[locale];
...
function parseDefaultLocale(value) {
 ...
 */
export function parseLocalizedNames(value) {
  if (value === undefined || value === null) return undefined;
...
//# sourceMappingURL=customers.controller-parsers.js.map
