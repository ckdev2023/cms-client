...
const INDIVIDUAL_BASE_PROFILE_SCHEMA = {
  name_cn: { type: "string" },
  name_en: { type: "string" },
  name_jp: { type: "string" },
  gender: { type: "string" },
...
/** 客户假名类字段。 */
export const CUSTOMER_KANA_FIELDS = ["kana", "furigana"];
export const CUSTOMER_OWNER_FIELDS = ["owner_user_id", "ownerUserId"];
export const CUSTOMER_GROUP_FIELDS = ["group", "group_id", "groupId"];
 ...
 * @returns SQL 谓词片段
 */
export function activeCustomerPredicate(alias) {
 ...
 * @returns 归一化后的姓名集合
 */
export function collectComparableNames(baseProfile) {
 ...
 */
export function getCustomerOwnerUserId(customer) {
 ...
 */
export function getCustomerCollaboratorUserIds(customer) {
 ...
 * @returns 去重后的 ID 列表
 */
export function normalizeDistinctIds(ids, fieldName) {
 ...
 */
export function validateBaseProfile(type, baseProfile) {
...
function stripEmptySchemaFields(baseProfile) {
...
function validateRequiredName(baseProfile, errors) {
...
function validateSchemaFields(baseProfile, errors) {
...
function validateEnumField(profile, field, allowed, errors) {
...
function validateOptionalStringField(profile, field, errors) {
  const value = profile[field];
  if (value === undefined || value === null) return;
...
//# sourceMappingURL=customers.utils.js.map
