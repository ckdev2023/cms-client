 ...
 * @returns 合并后的基础档案
 */
export function mergeLocalizedNamesIntoProfile(baseProfile, localizedNames) {
 ...
 * @returns 多语言名称 DTO
 */
export function resolveLocalizedNamesFromProfile(baseProfile) {
...
//# sourceMappingURL=customers.localized-names.js.map
