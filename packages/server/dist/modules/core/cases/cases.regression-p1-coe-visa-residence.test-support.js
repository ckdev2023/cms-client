...
function syncStageStatus(row, overrides) {
 ...
 */
export function makeTemplates(resolver) {
  return {
    service: {
      resolve: (_ctx, input) =>
        Promise.resolve(
...
export function svc(pool, templates) {
  return new CasesService(pool, (templates ?? makeTemplates()).service);
}
/**
 ...
 */
export function makeFullResidenceSummary(overrides = {}) {
  return {
    id: "rp-001",
 ...
 */
export function unsettled(mode, unpaid = 200000) {
  return { settled: false, unpaid, gateEffectMode: mode };
}
//# sourceMappingURL=cases.regression-p1-coe-visa-residence.test-support.js.map
