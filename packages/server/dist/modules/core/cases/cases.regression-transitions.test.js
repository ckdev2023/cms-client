...
function transitionPool(to, from) {
...
void test("§1 S9 is terminal — no outbound transitions", () => {
  const s9Tos = DEFAULT_CASE_TRANSITIONS.S9;
...
//# sourceMappingURL=cases.regression-transitions.test.js.map
