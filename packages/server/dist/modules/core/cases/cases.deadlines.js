 ...
 */
export function computeRemainingDays(dueAt, now = new Date()) {
 ...
 * @returns 紧急度等级
 */
export function computeSeverity(remainingDays) {
 ...
 * @returns 期限 DTO 数组
 */
export function deriveCaseDeadlines(source, now) {
...
//# sourceMappingURL=cases.deadlines.js.map
