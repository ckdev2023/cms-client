...
function parseOptionalComment(value) {
 ...
 */
let ReviewRecordsController = class ReviewRecordsController {
   ...
   */
  constructor(reviewRecordsService, casesService, permissionsService) {
...
__decorate(
  ...
  ReviewRecordsController.prototype,
  "create",
  null,
);
__decorate(
...
ReviewRecordsController = __decorate(
  [
    Controller("review-records"),
    __param(0, Inject(ReviewRecordsService)),
...
export { ReviewRecordsController };
//# sourceMappingURL=reviewRecords.controller.js.map
