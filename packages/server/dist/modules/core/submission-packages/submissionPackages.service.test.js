...
function makeSubmissionPackageRow(overrides = {}) {
  return {
    id: PACKAGE_ID,
    org_id: ORG_ID,
    case_id: CASE_ID,
...
function makeSubmissionPackageItemRow(overrides = {}) {
  return {
    id: ITEM_ID,
...
function createService(queryFn, caseStatus = "S7", reviewRequired = false) {
...
//# sourceMappingURL=submissionPackages.service.test.js.map
