...
function parseOptionalNullableUuid(value, field) {
  if (value === undefined) return undefined;
...
let UserDocumentsController = class UserDocumentsController {
   ...
   */
  constructor(userDocumentsService) {
...
__decorate(
  ...
  UserDocumentsController.prototype,
  "upload",
  null,
);
__decorate(
...
UserDocumentsController = __decorate(
  [
    ...
    __param(0, Inject(UserDocumentsService)),
...
//# sourceMappingURL=userDocuments.controller.js.map
