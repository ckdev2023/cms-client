...
async function seedCustomer(client) {
  await client.query(
...
async function seedDocumentItems(client) {
...
async function seedDocumentFile(client) {
  await client.query(
...
async function seedDocumentAsset(client) {
  await client.query(
...
async function seedDocumentChecklistTemplate(client) {
...
async function seedCrossCaseLink(client) {
  await client.query(
...
//# sourceMappingURL=seedDevData.js.map
