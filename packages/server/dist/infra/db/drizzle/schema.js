...
export const caseTemplates = pgTable(
  "case_templates",
  {
    ...
    defaultTasksBlueprint: jsonb("default_tasks_blueprint").$type(),
    validationRulesetRef: jsonb("validation_ruleset_ref").$type(),
    ...
    reminderScheduleBlueprint: jsonb("reminder_schedule_blueprint").$type(),
    activeFlag: boolean("active_flag").notNull().default(true),
    createdAt: timestamp("created_at", { withTimezone: true, mode: "string" })
      .notNull()
      .defaultNow(),
...
export const submissionPackages = pgTable(
  "submission_packages",
  {
    ...
    reviewRecordId: uuid("review_record_id").references(() => reviewRecords.id),
...
export const submissionPackageItems = pgTable(
  "submission_package_items",
  {
    ...
    snapshotPayload: jsonb("snapshot_payload").$type(),
    createdAt: timestamp("created_at", { withTimezone: true, mode: "string" })
      .notNull()
      .defaultNow(),
  },
