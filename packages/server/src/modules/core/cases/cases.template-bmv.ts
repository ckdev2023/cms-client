...
import type { ReminderScheduleBlueprintItem } from "./cases.types-template-blueprints";
 ...
 */
export const BMV_EXTRA_FIELDS_SCHEMA: CaseTemplateExtraFieldDef[] = [
  {
    fieldCode: "visa_plan",
    label: "ビザプラン",
    fieldType: "enum",
 ...
 */
export const BMV_REQUIREMENT_BLUEPRINT: CaseTemplateRequirementDef[] = [
  {
 ...
 */
export function buildBmvTemplateConfig(): Record<string, unknown> {
  return {
