...
const BASE_PERIOD: ResidencePeriod = {
  id: "rp-001",
  orgId: "org-001",
  caseId: "case-001",
  customerId: "cust-001",
...
const SUMMARY_FROM_PERIOD: CaseResidencePeriodSummary = {
  id: "rp-001",
  visaType: "business_manager",
  statusOfResidence: "経営・管理",
  periodYears: 1,
...
void describe("requiresSuccessCloseoutCheck", () => {
  ...
  void test("falls back to status when stage is null", () => {
    const c = mc({ stage: null, status: "S8" as never });
