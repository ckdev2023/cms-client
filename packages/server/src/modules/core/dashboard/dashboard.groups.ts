...
import type { DashboardGroupOption } from "./dashboard.shared";
 ...
 */
export async function findPrimaryGroupId(
  tx: TenantDbTx,
  userId: string,
...
export async function loadUserGroups(
  ...
  type Row = { id: string; name: string; is_primary_group: boolean };
 ...
 */
export async function loadOrgActiveGroups(
  tx: TenantDbTx,
