...
import type { CustomerQueryRow } from "../customers/customers.types";
...
function noopTimeline(): TimelineService {
  return {
...
const baseCustomerRow: CustomerQueryRow = {
  id: "cust-1",
  org_id: ORG_ID,
  type: "individual",
...
const baseCommLogRow = {
  ...
  follow_up_due_at: null as unknown,
  created_at: ISO as unknown,
};
