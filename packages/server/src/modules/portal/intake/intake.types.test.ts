...
import type {
  BmvQuestionnaireCreateInput,
  BmvQuestionnaireConfirmInput,
  BmvSurveyDataExtractInput,
  CaseCreationPrerequisite,
} from "./intake.types";
...
void describe("intake type contracts", () => {
  void test("BmvQuestionnaireCreateInput requires bmv_questionnaire formType", () => {
    const input: BmvQuestionnaireCreateInput = {
      appUserId: "user-1",
      leadId: "lead-1",
  ...
  void test("BmvQuestionnaireConfirmInput accepts optional surveyData", () => {
    const withData: BmvQuestionnaireConfirmInput = {
      intakeFormId: "form-1",
      surveyData: { companyInfo: {} },
    };
    assert.ok(withData.surveyData);

    const withoutData: BmvQuestionnaireConfirmInput = {
      intakeFormId: "form-1",
    };
  ...
  void test("BmvSurveyDataExtractInput requires all three IDs", () => {
    const input: BmvSurveyDataExtractInput = {
      intakeFormId: "form-1",
      caseId: "case-1",
  ...
  void test("CaseCreationPrerequisite includes requiresBmvGate flag", () => {
    const prereq: CaseCreationPrerequisite = {
