import type { CaseUpdateInput } from "./CaseAdapterTypes";
import {
...
export function buildUpdateCasePayload(
  ...
  return omitUndefined({
    ...
    overseasVisaStartAt: normalizeNullableString(input.overseasVisaStartAt),
    entryConfirmedAt: normalizeNullableString(input.entryConfirmedAt),
  });
}
