...
export const SAMPLE_CASE_LIST: CaseListItem[] = [
  ...
  },
  {
    ...
    validationLabel: { status: "failed", blockingCount: 2 },
    blockerCount: 2,
    unpaidAmount: 120000,
    updatedAtLabel: "今天 11:05",
    dueDate: "2026-04-14",
  ...
  },
  {
    ...
    validationLabel: { status: "passed", blockingCount: 0 },
    blockerCount: 0,
    unpaidAmount: 0,
  ...
  },
  {
    ...
    validationStatus: "failed",
    validationLabel: { status: "failed", blockingCount: 1 },
    blockerCount: 1,
    unpaidAmount: 90000,
  ...
  },
  {
    ...
    sampleKey: "arrears",
    visibleScopes: ["mine", "group", "all"],
    workflowStepCode: "ENTRY_SUCCESS",
    workflowStepLabel: "入境成功",
  },
  {
    id: "CAS-2026-0245",
    name: "陈小宝 家族滞在认定(补正)",
...
export const SAMPLE_SUMMARY_CARDS: CaseSummaryCardData[] = [
  {
    ...
    value: 18,
    label: "进行中案件",
    i18nKey: "cases.constants.summaryCards.activeCases",
  },
  {
    ...
    value: 3,
    label: "检查未通过",
    i18nKey: "cases.constants.summaryCards.failedValidations",
  },
  {
    key: "dueSoon",
    variant: "warning",
    value: 5,
    label: "即将到期",
    i18nKey: "cases.constants.summaryCards.dueSoon",
  },
  {
    key: "unpaidTotal",
    variant: "neutral",
    value: 480000,
    label: "待收金额",
    i18nKey: "cases.constants.summaryCards.unpaidTotal",
  },
];
