  ...
  "cust-001": [
    {
      ...
      type: "info",
      actor: "山田翔太",
      at: "2026-04-10T14:35:00Z",
      message: "customer.updated: phone, email",
    },
    {
      id: "LOG-001-2",
      type: "comm",
      ...
      message: "communication_log.created: phone",
    },
    {
      id: "LOG-001-3",
      type: "case",
      ...
      message: "case.created: BMV 1-year renewal",
    },
    {
      id: "LOG-001-4",
      type: "relation",
      ...
      message: "contact_person.created: Tanaka Hanako (spouse)",
    },
  ],
  "cust-002": [
    {
      ...
      type: "comm",
      actor: "山田翔太",
      at: "2026-04-12T15:05:00Z",
      message: "communication_log.created: meeting",
    },
    {
      id: "LOG-002-2",
      type: "case",
      ...
      message: "case.created: BMV 4-month certification",
    },
    {
      id: "LOG-002-3",
      type: "relation",
      ...
      message: "contact_person.created: Chen Xiaoming (parent)",
    },
  ],
  "cust-003": [
    {
      ...
      type: "case",
      actor: "高橋健太",
      at: "2024-12-15T09:30:00Z",
      message: "case.created: Engineer/Specialist certification",
    },
  ],
  "cust-004": [],
};
...
export const SAMPLE_CUSTOMER_DETAILS: Record<string, CustomerDetail> = {
  ...
  "cust-002": {
    ...
    caseTypeCodes: ["business_manager_visa", "business_manager_visa"],
  ...
  "cust-003": {
    ...
    caseTypeCodes: ["engineer_humanities_intl_visa"],
