const customerDetail = {
  ...
  actions: {
    ...
    createCaseGate: {
      ...
      featureDisabled:
        "経営管理ビザ機能が本テナントで有効化されていないため、契約および案件作成を進められません。管理者に BMV 機能フラグの有効化を依頼してください。",
    },
  },
  header: {
    number: "番号",
  ...
  bmvIntake: {
    ...
    note: "補足メモ",
    disabledNotice: {
      ariaLabel: "経営管理ビザ機能が無効である旨の通知",
      title: "経営管理ビザ機能が無効です",
      description:
        "本テナントでは経営管理ビザ (BMV) 機能フラグが有効化されていません。問診票送信・見積生成・契約登録は実行できず、「案件を開始」も無効のままです。",
      hint: "システム設定で BMV 機能を有効化するよう管理者に連絡してください。実際のビザ種別が異なる場合は、ビザ種別を該当の値に変更してから再試行してください。",
    },
    steps: {
      questionnaire: "問診票",
      quote: "見積",
