const customerList = {
  ...
  summarySubtitle:
    "他モジュールと同じ概要カードの体裁です。数値はこのページで読み込まれた表示行のみを集計し、絞込・ページ送りで変わります。事務所全体の件数とは限りません。一覧フッタの件数と照合してください。",
  summary: {
    mine: {
      label: "自分の顧客",
      hint: "このページの表示行のうち、自分が担当の顧客数です。",
    },
    group: {
      label: "組の顧客",
      hint: "表示行のうち、このページで自分担当の顧客から推定した最頻グループと一致する行数です。複数グループを跨ぐと「自分の顧客」より少なくなることがあります。",
    },
    active: {
      label: "活動中案件あり",
      hint: "表示行のうち、進行中の案件が1件以上ある顧客数です。",
    },
    noActive: {
      label: "活動中案件なし",
      hint: "表示行のうち、進行中の案件がない顧客数です。",
    },
  },
  scopeLabel: "データ範囲",
  scope: {
