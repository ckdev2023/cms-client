...
const zhCN = {
  ...
  customers: {
    list: {
      ...
      summaryTitle: "客户工作概览",
      summarySubtitle:
        "沿用资料中心的摘要卡片布局。数字仅基于当前页的可见客户行（随筛选与分页变化），与后端全量统计不同；请以列表下方的「当前查看」对齐预期。",
      summary: {
        mine: {
          label: "我的客户",
          hint: "当前页可见行中由我负责的客户数。",
        },
        group: {
          label: "本组客户",
          hint: "当前页可见行中，且分组与我名下客户最常见分组一致的条目数；跨分组负责时可能少于「我的客户」。",
        },
        active: {
          label: "有活跃案件",
          hint: "当前页可见行中至少有一项进行中案件的客户数。",
        },
        noActive: {
          label: "无活跃案件",
          hint: "当前页可见行中暂无进行中案件的客户数。",
        },
      },
      scopeLabel: "数据范围",
