...
const casesJaJP = {
  ...
  detail: {
    ...
    messages: {
      ...
      reply: "返信",
      edit: "編集",
      replyDraftHeader: "{author}（{time}）への返信",
      empty: "連絡記録がありません",
      filterEmpty: "このフィルターに該当する記録はありません",
      filterTitle: "フィルター",
      filterReset: "リセット",
  ...
  log: {
    ...
    timeline: {
      ...
      documentItemTransitioned: "資料項目ステータス変更{colonSuffix}",
      documentItemWaived: "資料項目免除{colonSuffix}",
      documentItemUnwaived: "資料項目免除取消",
      documentItemDeleted: "資料項目削除",
      documentItemSurveyDataUpdated: "資料項目調査データ更新",
      ...
      validationRunAutoFailed: "自動チェック失敗{colonSuffix}",
      ...
      generatedDocumentExportFailed: "文書のエクスポートに失敗{colonSuffix}",
