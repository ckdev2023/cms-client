const billingJaJP = {
  list: {
    ...
    bulk: {
      ...
      clear: "クリア",
      collect: "一括督促タスク作成",
      emptyHint: "現在、延滞中の請求がないため、一括督促はできません",
    },
    pagination: {
  ...
  paymentModal: {
    title: "入金登録",
    closeAriaLabel: "閉じる",
    hint: "入金情報を入力してください。原則として案件ごとに一括請求が1件です。金額と日付は必須です。",
    fields: {
      amount: "金額 (¥)",
      amountPlaceholder: "入金額を入力",
      amountWarning:
        "金額が当該請求の未入金残高を超えています。複数回に分けて登録するか、請求額をご確認ください。",
      date: "日付",
      node: "関連請求プラン",
      nodePlaceholder: "請求プランを選択",
      nodeError:
        "未清算の請求が複数あります。先に対象の請求プランを選択してください。",
      receipt: "支払証憑",
